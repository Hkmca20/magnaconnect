...
public class PDB implements Cons {
...
//        preferences = PreferenceManager.getDefaultSharedPreferences(appContext);
        preferences = BApp.getInstance().getContext().getSharedPreferences(PF_BTS, Context.MODE_PRIVATE);
    }
    ...
    // TODO: 2/14/2019 below both getObject methods are responsible for same functionality, you can use any of one
...
//    }
    ...
    public void putListObject(String key, ArrayList<SpinItem> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
