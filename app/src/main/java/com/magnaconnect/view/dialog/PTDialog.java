...
public class PTDialog extends Dialog {
    String TAG = PTDialog.class.getCanonicalName();
    Utils.OnDialogIntOkClickListener onDialogIntOkClickListener;
    OnCancelListener onCancelListener;
    Activity activity;
    List<StatResponse.PartnerTypeItem> spinnerList;
    String titleString;
    boolean can;

    public PTDialog(@NonNull Activity context, List<StatResponse.PartnerTypeItem> spinnerList, String titleString, boolean cancelable, @Nullable OnCancelListener cancelListener, Utils.OnDialogIntOkClickListener onDialogIntOkClickListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PTAdapter spinAdapter = new PTAdapter(activity, spinnerList);
        mRecyclerView.setItemAnimator(new DefaultItemAnimator());
        ...
        mSearchView.addTextChangedListener(new MyTextWatcher(null, spinAdapter, null));
