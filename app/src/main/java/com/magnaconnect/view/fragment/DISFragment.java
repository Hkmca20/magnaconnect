...
public class DISFragment extends BFragment implements S2Contract.View {
    private static DISFragment INSTANCE;
    ...
    private String TAG = DISFragment.class.getSimpleName();
    ...
    public static DISFragment newInstance() {
        Bundle b = new Bundle();
        DISFragment f = new DISFragment();
        f.setArguments(b);
        return f;
    }

    public static DISFragment getInstance() {
        return INSTANCE;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        initFragment(view, activity, SCREEN_Distrib, statusColor, themeColor, true);
        setRecyclerView(view);
        CallDealerService();
    }

    public void CallDealerService() {
        presenter.distdList(getUser());
    }
    ...
    private void setRecyclerView(View view) {
        ...
        adapter = new DISAdapter(activity, dealerList);
        mRecyclerView.setItemAnimator(new DefaultItemAnimator());
        mRecyclerView.setAdapter(adapter);
        adapter.notifyDataSetChanged();
        ((DISAdapter) adapter).setOnItemClickListener((id, position, v) -> {
            switch (v.getId()) {
                case R.id.card_view:
                    break;
