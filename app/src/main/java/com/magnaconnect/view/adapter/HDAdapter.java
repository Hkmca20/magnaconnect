...
public class HDAdapter extends RecyclerView.Adapter<HDAdapter.DataObjectHolder> implements Filterable {
    private static String TAG = HDAdapter.class.getSimpleName();
    ...
    public HDAdapter(Activity activity, List<DashResponse.Inventory> gridList) {
...
//            holder.mSquareView.setBackground(statesLayout);
            ...
            s1 = s1 + "\nModule Name: " +item.getModuleName();
            s1 = s1 + "\nModule No: " +item.getModuleNo();
